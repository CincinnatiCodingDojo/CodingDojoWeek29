...
Two middleware functions are provided by default in the `rpslp.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `rpslp.handler` namespace to manage the enabled middleware.
